<?php
namespace OldElastica\Type;

use OldElastica\Client;
use OldElastica\Exception\InvalidException;
use OldElastica\Index;
use OldElastica\SearchableInterface;
use OldElastica\Type as BaseType;
...
abstract class AbstractType implements SearchableInterface
{
     ...
     * Index.
     *
     * @var \OldElastica\Index Index object
     */
     ...
     * Type.
     *
     * @var \OldElastica\Type Type object
     */
     ...
     *
     * @param \OldElastica\Client $client OPTIONAL Client object
     *
    ...
    /**
     * @param string|\OldElastica\Query $query
     ...
     *
     * @return \OldElastica\Index Index object
     */
