...
class Mapping
{
     ...
     * Construct Mapping.
     *
     * @param \OldElastica\Type $type       OPTIONAL Type object
     ...
     *
     * @param \OldElastica\Type $type Type object
     *
     * @return $this
     */
     ...
     *
     * @param array|\OldElastica\Type\Mapping $mapping Mapping object or properties array
     *
     * @throws \OldElastica\Exception\InvalidException If invalid type
     *
     * @return self
     */
