...
use OldElastica\Exception\JSONParseException;
use OldElastica\Exception\NotFoundException;

/**
 * OldElastica Response object.
 *
...
class Response
{
     ...
     * from the \OldElastica\Client::_callService .
     *
     ...
     * Time request took.
     *
     * @throws \OldElastica\Exception\NotFoundException
     *
