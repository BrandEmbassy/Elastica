...
class CrossIndex
{
     ...
     * Type option.
     *
     * type: string | string[] | \OldElastica\Type | \OldElastica\Type[] | null
     ...
     * Query option.
     *
     * type: see \OldElastica\Query::create()
     * default: OldElastica\Query\MatchAll
     */
     ...
     * Expiry time option.
     *
     * type: string (see OldElastica\ScanAndScroll)
     * default: '1m'
     */
     ...
     *
     * type: int (see OldElastica\ScanAndScroll)
     * default: 1000
     */
     ...
     *
     * @param \OldElastica\Index $oldIndex
     * @param \OldElastica\Index $newIndex
     * @param array           $options  keys: CrossIndex::OPTION_* constants
     *
     * @return \OldElastica\Index The new index object
     */
     ...
     *
     * @see \OldElastica\Tool\CrossIndex::reindex()
     *
     * @param \OldElastica\Index $oldIndex
     * @param \OldElastica\Index $newIndex
     * @param array           $options  keys: CrossIndex::OPTION_* constants
