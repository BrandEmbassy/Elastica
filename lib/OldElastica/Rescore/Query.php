<?php
namespace OldElastica\Rescore;

use OldElastica\Query as BaseQuery;
...
class Query extends AbstractRescore
{
     ...
     * Constructor.
     *
     * @param string|\OldElastica\Query\AbstractQuery $query
     */
     ...
     *
     * @param string|\OldElastica\Query|\OldElastica\Query\AbstractQuery $rescoreQuery
     *
     * @return $this
     */
