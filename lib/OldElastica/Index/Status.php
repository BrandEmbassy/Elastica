<?php
namespace OldElastica\Index;

use OldElastica\Index as BaseIndex;
use OldElastica\Request;

/**
 * OldElastica index status object.
 *
...
class Status
{
     ...
     * Construct.
     *
     * @param \OldElastica\Index $index Index object
     */
    ...
    {
        $responseData = $this->getIndex()->request('_aliases', \OldElastica\Request::GET)->getData();
    ...
    {
        $responseData = $this->getIndex()->request('_settings', \OldElastica\Request::GET)->getData();
