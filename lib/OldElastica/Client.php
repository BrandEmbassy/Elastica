...
class Client
{
     ...
     * retryOnConflict: Use in \OldElastica\Client::updateDocument
    ...
    /**
     * Creates a new OldElastica client.
     *
     ...
     *
     * @return \OldElastica\Index Index for the given name
     */
     ...
     *
     * @throws \OldElastica\Exception\InvalidException If $header or $headerValue is not a string
     *
     * @return $this
     */
     ...
     *
     * @throws \OldElastica\Exception\InvalidException If $header is not a string
     *
     * @return $this
     */
     ...
     *
     * Array of \OldElastica\Document as input. Index and type has to be
     * set inside the document, because for bulk settings documents,
     * documents can belong to any type and index
     *
     * @link http://www.elastic.co/guide/en/elasticsearch/reference/current/docs-bulk.html
     *
     * @param array|\OldElastica\Document[] $docs Array of OldElastica\Document
     *
     * @throws \OldElastica\Exception\InvalidException If docs is empty
     *
     * @return \OldElastica\Bulk\ResponseSet Response object
     */
    public function updateDocuments(array $docs)
    {
        ...
        $bulk->addDocuments($docs, \OldElastica\Bulk\Action::OP_TYPE_UPDATE);
     ...
     * @param array|\OldElastica\Script|\OldElastica\Document $data    raw data for request body
     * @param string                                    $index   index to update
     * @param string                                    $type    type of index to update
     * @param array                                     $options array of query params to use for query. For possible options check es api
     *
     * @return \OldElastica\Response
     *
     ...
     *
     * @param array|\OldElastica\Document[] $docs
     *
     * @throws \OldElastica\Exception\InvalidException
     *
     * @return \OldElastica\Bulk\ResponseSet
     */
     ...
     *
     * @return \OldElastica\Status Status object
     */
     ...
     *
     * @return \OldElastica\Cluster Cluster object
     */
     ...
     * @param string|\OldElastica\Index $index   Index name
     * @param string|\OldElastica\Type  $type    Type of documents
     ...
     *
     * @throws \OldElastica\Exception\ResponseException
     * @throws \OldElastica\Exception\InvalidException
     *
     * @return \OldElastica\Bulk\ResponseSet Response object
     */
     ...
     * logging.
     *
     * @param string|\OldElastica\Request $context
     *
