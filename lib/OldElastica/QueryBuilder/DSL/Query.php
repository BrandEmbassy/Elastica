...
use OldElastica\Query\BoolQuery;
use OldElastica\Query\Boosting;
use OldElastica\Query\Common;
use OldElastica\Query\ConstantScore;
use OldElastica\Query\DisMax;
use OldElastica\Query\Filtered;
use OldElastica\Query\FunctionScore;
use OldElastica\Query\Fuzzy;
use OldElastica\Query\FuzzyLikeThis;
use OldElastica\Query\HasChild;
use OldElastica\Query\HasParent;
use OldElastica\Query\Ids;
use OldElastica\Query\Match;
use OldElastica\Query\MatchAll;
use OldElastica\Query\MoreLikeThis;
...
use OldElastica\Query\TopChildren;
use OldElastica\Query\Wildcard;
...
class Query implements DSL
{
     ...
     *
     * @return \OldElastica\Query\MultiMatch
     */
     ...
     *
     * @return \OldElastica\Query\BoolQuery
     */
     ...
     *
     * @param null|\OldElastica\Filter\AbstractFilter|array $filter
     *
     ...
     *
     * @param array|string|\OldElastica\Type $type
     * @param array                       $ids
     *
     * @return Ids
     */
     ...
     *
     * @param string|AbstractQuery|\OldElastica\Query $query
     * @param string                               $type
     *
     * @return TopChildren
     */
