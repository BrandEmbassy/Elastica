...
use OldElastica\Filter\GeoDistance;
...
class Filter implements DSL
{
     ...
     *
     * @return \OldElastica\Filter\Bool
     */
     ...
     *
     * @param array|string|\OldElastica\Script $script
     *
     * @return Script
     */
