...
class QueryString extends AbstractQuery
{
     ...
     *
     * @throws \OldElastica\Exception\InvalidException If given parameter is not a string
     *
     * @return $this
     */
     ...
     *
     * @throws \OldElastica\Exception\InvalidException If given parameter is not an array
     *
     * @return $this
     */
