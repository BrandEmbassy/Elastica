...
class BoolQuery extends AbstractQuery
{
     ...
     *
     * @param \OldElastica\Query\AbstractQuery|array $args Should query
     *
     * @return $this
     */
     ...
     *
     * @param \OldElastica\Query\AbstractQuery|array $args Must query
     *
     * @return $this
     */
     ...
     *
     * @param \OldElastica\Query\AbstractQuery|array $args Must not query
     *
     * @return $this
     */
     ...
     * @param \OldElastica\Query\AbstractQuery|array $args Query
     *
     * @throws \OldElastica\Exception\InvalidException If not valid query
     *
     * @return $this
     */
    protected function _addQuery($type, $args)
    {
        if (!is_array($args) && !($args instanceof AbstractQuery)) {
            throw new InvalidException('Invalid parameter. Has to be array or instance of OldElastica\Query\AbstractQuery');
        }
