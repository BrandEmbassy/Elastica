<?php
namespace OldElastica\Exception\Bulk;

use OldElastica\Bulk\ResponseSet;
use OldElastica\Exception\Bulk\Response\ActionException;
...
{
    /**
     * @var \OldElastica\Bulk\ResponseSet ResponseSet object
     */
    protected $_responseSet;

    /**
     * @var \OldElastica\Exception\Bulk\Response\ActionException[]
     */
     ...
     * Construct Exception.
     *
     * @param \OldElastica\Bulk\ResponseSet $responseSet
     */
    ...
    /**
     * @return \OldElastica\Exception\Bulk\Response\ActionException[]
     */
