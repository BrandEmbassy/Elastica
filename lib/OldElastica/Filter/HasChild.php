...
class HasChild extends AbstractFilter
{
     ...
     *
     * @param string|\OldElastica\Query|\OldElastica\Filter\AbstractFilter $query Query string or a OldElastica\Query object or a filter
     * @param string|\OldElastica\Type                                  $type  Child document type
     */
