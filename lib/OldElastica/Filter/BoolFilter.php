...
class BoolFilter extends AbstractFilter
{
     ...
     * Adds should filter.
     *
     * @param array|\OldElastica\Filter\AbstractFilter $args Filter data
     *
     * @return $this
     */
    ...
    protected function _addFilter($type, $args)
    {
        if (!is_array($args) && !($args instanceof AbstractFilter)) {
            throw new InvalidException('Invalid parameter. Has to be array or instance of OldElastica\Filter');
        }
