...
class Percolator
{
     ...
     * @param string|\OldElastica\Query|\OldElastica\Query\AbstractQuery $query  Query to add
     ...
     *
     * @param \OldElastica\Document                                   $doc
     * @param string|\OldElastica\Query|\OldElastica\Query\AbstractQuery $query  Query to filter the percolator queries which
     *                                                                     are executed.
     * @param string                                               $type
    ...
    /**
     * @param string                                               $path
     * @param string|\OldElastica\Query|\OldElastica\Query\AbstractQuery $query] $query  [description]
     * @param array                                                $data
     * @param array                                                $params
     *
     * @return array
