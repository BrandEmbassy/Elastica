...
use OldElastica\ResultSet as BaseResultSet;
use OldElastica\Search as BaseSearch;

/**
 * OldElastica multi search result set
...
class ResultSet implements \Iterator, \ArrayAccess, \Countable
{
     ...
     * Result Sets.
     *
     * @var array|\OldElastica\ResultSet[] Result Sets
     */
        ...
        if (isset($responseData['responses']) && is_array($responseData['responses'])) {
            ...
            foreach ($responseData['responses'] as $key => $responseData) {
                ...
                if ($currentSearch === false) {
                    ...
                    throw new InvalidException('Invalid object for search #'.$key.' provided. Should be OldElastica\Search');
                }
    ...
    /**
     * @return array|\OldElastica\ResultSet[]
     */
    ...
    /**
     * @return bool|\OldElastica\ResultSet
     */
