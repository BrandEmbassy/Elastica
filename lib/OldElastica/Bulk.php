...
use OldElastica\Bulk\Action\AbstractDocument as AbstractDocumentAction;
use OldElastica\Bulk\Response as BulkResponse;
use OldElastica\Bulk\ResponseSet;
use OldElastica\Exception\Bulk\ResponseException as BulkResponseException;
use OldElastica\Exception\Bulk\UdpException;
...
class Bulk
{
    ...
    /**
     * @param string|\OldElastica\Index $index
     *
     * @return $this
     */
    ...
    /**
     * @param string|\OldElastica\Type $type
     *
     * @return $this
     */
    ...
    /**
     * @param \OldElastica\Bulk\Action[] $actions
     *
     * @return $this
     */
    ...
    /**
     * @param \OldElastica\Document[] $documents
     * @param string               $opType
     *
     * @return $this
     */
    ...
    /**
     * @param \OldElastica\Script $script
     * @param string           $opType
     *
     * @return $this
     */
    ...
    /**
     * @param \OldElastica\Document[] $scripts
     * @param string               $opType
     *
     * @return $this
     */
    ...
    /**
     * @param \OldElastica\Script|\OldElastica\Document|array $data
     * @param string                                    $opType
     *
     * @return $this
     */
     ...
     *
     * @throws \OldElastica\Exception\Bulk\ResponseException
     * @throws \OldElastica\Exception\InvalidException
     *
     * @return \OldElastica\Bulk\ResponseSet
     */
     ...
     * @param int    $port
     *
     * @throws \OldElastica\Exception\Bulk\UdpException
     */
