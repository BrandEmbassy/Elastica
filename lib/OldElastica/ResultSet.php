...
class ResultSet implements \Iterator, \Countable, \ArrayAccess
{
     ...
     * Query.
     *
     * @var \OldElastica\Query Query object
     */
    protected $_query;
     ...
     *
     * @param \OldElastica\Response $response Response object
     * @param \OldElastica\Query    $query    Query object
     */
     ...
     *
     * @return \OldElastica\Result|bool Set object or false if not valid (no more entries)
     */
