...
class Type implements SearchableInterface
{
     ...
     *
     * @param \OldElastica\Document $doc Document with data
     *
     ...
     *
     * @param \OldElastica\Document|\OldElastica\Script $data    Document with update data
     ...
     *
     * @param \OldElastica\Type\Mapping|array $mapping OldElastica\Type\MappingType object or property array with all mappings
     *
     * @return \OldElastica\Response
     */
     ...
     *
     * @param \OldElastica\Document           $doc    Document to query for similar objects
     * @param array                        $params OPTIONAL Additional arguments for the query
     * @param string|array|\OldElastica\Query $query  OPTIONAL Query to filter the moreLikeThis results
     *
     * @return \OldElastica\ResultSet ResultSet with all results inside
     *
     ...
     *
     * @see \OldElastica\Type::addObject
     *
     * @param array|string $serializer @see \OldElastica\Type::_serializer
     *
     * @return $this
     */
