...
use OldElastica\Transport\AbstractTransport;

/**
 * OldElastica connection instance to an elasticasearch node.
 *
...
class Connection extends Param
{
     ...
     *
     * @throws \OldElastica\Exception\InvalidException If invalid transport type
     *
     * @return \OldElastica\Transport\AbstractTransport Transport object
     */
    ...
    /**
     * @param \OldElastica\Connection|array $params Params to create a connection
     *
