...
use OldElastica\Suggest\AbstractSuggest;

/**
 * OldElastica query object.
 *
...
class Query extends Param
{
     ...
     *
     * @param array|\OldElastica\Query\AbstractQuery $query OPTIONAL Query object (default = null)
     */
     ...
     * @param mixed $query
     *
     * @throws \OldElastica\Exception\NotImplementedException
     *
     * @return self
     */
    ...
    {
        trigger_error('Deprecated: OldElastica\Query::setFilter() is deprecated. Use OldElastica\Query::setPostFilter() instead.', E_USER_DEPRECATED);
     ...
     * Set script fields.
     *
     * @param array|\OldElastica\ScriptFields $scriptFields Script fields
     *
     * @return $this
     *
     ...
     *
     * @param string                   $name
     * @param \OldElastica\AbstractScript $script Script object
     *
     * @return $this
     */
     ...
     *
     * @param \OldElastica\Facet\AbstractFacet $facet Facet object
     *
     * @return $this
     *
     * @deprecated Facets are deprecated and will be removed in a future release. You are encouraged to migrate to aggregations instead.
     ...
     * Add a suggest term.
     *
     * @param \OldElastica\Suggest $suggest suggestion object
     *
     * @return $this
     */
     ...
     *
     * @param array|\OldElastica\Filter\AbstractFilter $filter
     *
     * @return $this
     *
    ...
    public function setPostFilter($filter)
    {
        if (!($filter instanceof AbstractFilter)) {
            trigger_error('Deprecated: OldElastica\Query::setPostFilter() passing filter as array is deprecated. Pass instance of AbstractFilter instead.', E_USER_DEPRECATED);
        }
