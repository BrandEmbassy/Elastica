...
class Search
{
     ...
     *
     * @param \OldElastica\Index|string $index Index object or string
     *
     ...
     *
     * @param \OldElastica\Type|string $type Type name or object
     *
     * @throws \OldElastica\Exception\InvalidException
     *
     * @return $this
    ...
    /**
     * @param string|array|\OldElastica\Query|\OldElastica\Suggest|\OldElastica\Query\AbstractQuery|\OldElastica\Filter\AbstractFilter $query|
     *
     * @return $this
     */
     ...
     *
     * @return \OldElastica\Client Client object
     */
    ...
    /**
     * @param \OldElastica\Type|string $type
     *
     * @return bool
     */
     ...
     *
     * @param \OldElastica\SearchableInterface $searchObject
     *
     * @return Search
     */
