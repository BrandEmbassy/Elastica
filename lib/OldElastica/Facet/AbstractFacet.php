...
use OldElastica\NameableInterface;
...
abstract class AbstractFacet extends Param implements NameableInterface
{
     ...
     * @param string $name The name of the facet.
     *
     * @throws \OldElastica\Exception\InvalidException If name is empty
     *
     * @return $this
     */
     ...
     *
     * @param \OldElastica\Filter\AbstractFilter $filter A filter to apply on the facet.
     *
     * @return $this
     */
