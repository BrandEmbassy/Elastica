...
class Search
{
     ...
     *
     * @param \Elastica2\Index|string $index Index object or string
     *
     ...
     *
     * @param \Elastica2\Type|string $type Type name or object
     *
     * @throws \Elastica2\Exception\InvalidException
     *
     * @return $this
    ...
    /**
     * @param string|array|\Elastica2\Query|\Elastica2\Suggest|\Elastica2\Query\AbstractQuery|\Elastica2\Filter\AbstractFilter $query|
     *
     * @return $this
     */
     ...
     *
     * @return \Elastica2\Client Client object
     */
    ...
    /**
     * @param \Elastica2\Type|string $type
     *
     * @return bool
     */
     ...
     *
     * @param \Elastica2\SearchableInterface $searchObject
     *
     * @return Search
     */
