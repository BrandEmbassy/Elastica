...
use Elastica2\JSON;
use Elastica2\Request as ElasticaRequest;
use Elastica2\Response as ElasticaResponse;
...
class HttpAdapter extends AbstractTransport
{
     ...
     *
     * @param \Elastica2\Request $elasticaRequest
     * @param array             $params          Host, Port, ...
     *
     * @throws \Elastica2\Exception\ConnectionException
     * @throws \Elastica2\Exception\ResponseException
     * @throws \Elastica2\Exception\Connection\HttpException
     *
