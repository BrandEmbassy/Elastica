...
use Elastica2\Transport\AbstractTransport;

/**
 * Elastica2 connection instance to an elasticasearch node.
 *
...
class Connection extends Param
{
     ...
     *
     * @throws \Elastica2\Exception\InvalidException If invalid transport type
     *
     * @return \Elastica2\Transport\AbstractTransport Transport object
     */
    ...
    /**
     * @param \Elastica2\Connection|array $params Params to create a connection
     *
