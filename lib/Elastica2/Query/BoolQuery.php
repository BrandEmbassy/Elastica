...
class BoolQuery extends AbstractQuery
{
     ...
     *
     * @param \Elastica2\Query\AbstractQuery|array $args Should query
     *
     * @return $this
     */
     ...
     *
     * @param \Elastica2\Query\AbstractQuery|array $args Must query
     *
     * @return $this
     */
     ...
     *
     * @param \Elastica2\Query\AbstractQuery|array $args Must not query
     *
     * @return $this
     */
     ...
     * @param \Elastica2\Query\AbstractQuery|array $args Query
     *
     * @throws \Elastica2\Exception\InvalidException If not valid query
     *
     * @return $this
     */
