...
class QueryString extends AbstractQuery
{
     ...
     *
     * @throws \Elastica2\Exception\InvalidException If given parameter is not a string
     *
     * @return $this
     */
     ...
     *
     * @throws \Elastica2\Exception\InvalidException If given parameter is not an array
     *
     * @return $this
     */
