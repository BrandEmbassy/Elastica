...
class Mapping
{
     ...
     * Construct Mapping.
     *
     * @param \Elastica2\Type $type       OPTIONAL Type object
     ...
     *
     * @param \Elastica2\Type $type Type object
     *
     * @return $this
     */
     ...
     *
     * @param array|\Elastica2\Type\Mapping $mapping Mapping object or properties array
     *
     * @throws \Elastica2\Exception\InvalidException If invalid type
     *
     * @return self
     */
