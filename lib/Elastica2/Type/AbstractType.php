<?php
namespace Elastica2\Type;

use Elastica2\Client;
use Elastica2\Exception\InvalidException;
use Elastica2\Index;
use Elastica2\SearchableInterface;
use Elastica2\Type as BaseType;
use Elastica2\Util;
...
abstract class AbstractType implements SearchableInterface
{
     ...
     * Index.
     *
     * @var \Elastica2\Index Index object
     */
     ...
     * Type.
     *
     * @var \Elastica2\Type Type object
     */
     ...
     *
     * @param \Elastica2\Client $client OPTIONAL Client object
     *
    ...
    /**
     * @param string|\Elastica2\Query $query
     ...
     *
     * @return \Elastica2\Index Index object
     */
