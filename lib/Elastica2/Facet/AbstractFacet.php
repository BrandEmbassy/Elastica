...
abstract class AbstractFacet extends Param implements NameableInterface
{
     ...
     * @param string $name The name of the facet.
     *
     * @throws \Elastica2\Exception\InvalidException If name is empty
     *
     * @return $this
     */
     ...
     *
     * @param \Elastica2\Filter\AbstractFilter $filter A filter to apply on the facet.
     *
     * @return $this
     */
