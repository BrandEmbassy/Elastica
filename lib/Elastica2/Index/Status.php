<?php
namespace Elastica2\Index;

use Elastica2\Index as BaseIndex;
use Elastica2\Request;

/**
 * Elastica2 index status object.
 *
...
class Status
{
     ...
     * Construct.
     *
     * @param \Elastica2\Index $index Index object
     */
    ...
    {
        $responseData = $this->getIndex()->request('_aliases', \Elastica2\Request::GET)->getData();
    ...
    {
        $responseData = $this->getIndex()->request('_settings', \Elastica2\Request::GET)->getData();
