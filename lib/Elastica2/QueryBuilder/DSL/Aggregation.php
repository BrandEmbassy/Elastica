...
use Elastica2\Aggregation\Cardinality;
use Elastica2\Aggregation\DateHistogram;
use Elastica2\Aggregation\DateRange;
use Elastica2\Aggregation\ExtendedStats;
use Elastica2\Aggregation\Filter as FilterAggregation;
use Elastica2\Aggregation\Filters;
use Elastica2\Aggregation\GeoDistance;
use Elastica2\Aggregation\GeohashGrid;
use Elastica2\Aggregation\GlobalAggregation;
use Elastica2\Aggregation\Histogram;
use Elastica2\Aggregation\IpRange;
use Elastica2\Aggregation\Max;
use Elastica2\Aggregation\Min;
use Elastica2\Aggregation\Missing;
use Elastica2\Aggregation\Nested;
use Elastica2\Aggregation\Percentiles;
use Elastica2\Aggregation\Range;
use Elastica2\Aggregation\ReverseNested;
use Elastica2\Aggregation\ScriptedMetric;
use Elastica2\Aggregation\SignificantTerms;
use Elastica2\Aggregation\Stats;
use Elastica2\Aggregation\Sum;
