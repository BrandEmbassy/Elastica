...
class Percolator
{
     ...
     * @param string|\Elastica2\Query|\Elastica2\Query\AbstractQuery $query  Query to add
     ...
     *
     * @param \Elastica2\Document                                   $doc
     * @param string|\Elastica2\Query|\Elastica2\Query\AbstractQuery $query  Query to filter the percolator queries which
     *                                                                     are executed.
     * @param string                                               $type
    ...
    /**
     * @param string                                               $path
     * @param string|\Elastica2\Query|\Elastica2\Query\AbstractQuery $query] $query  [description]
     * @param array                                                $data
     * @param array                                                $params
     *
     * @return array
