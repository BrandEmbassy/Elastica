<?php
namespace Elastica2\Exception\Bulk;

use Elastica2\Bulk\ResponseSet;
use Elastica2\Exception\Bulk\Response\ActionException;
use Elastica2\Exception\BulkException;
...
{
    /**
     * @var \Elastica2\Bulk\ResponseSet ResponseSet object
     */
    protected $_responseSet;

    /**
     * @var \Elastica2\Exception\Bulk\Response\ActionException[]
     */
     ...
     * Construct Exception.
     *
     * @param \Elastica2\Bulk\ResponseSet $responseSet
     */
    ...
    /**
     * @return \Elastica2\Exception\Bulk\Response\ActionException[]
     */
