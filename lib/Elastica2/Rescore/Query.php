<?php
namespace Elastica2\Rescore;

use Elastica2\Query as BaseQuery;
...
class Query extends AbstractRescore
{
     ...
     * Constructor.
     *
     * @param string|\Elastica2\Query\AbstractQuery $query
     */
     ...
     *
     * @param string|\Elastica2\Query|\Elastica2\Query\AbstractQuery $rescoreQuery
     *
     * @return $this
     */
