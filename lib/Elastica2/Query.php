...
use Elastica2\Suggest\AbstractSuggest;

/**
 * Elastica2 query object.
 *
...
class Query extends Param
{
     ...
     *
     * @param array|\Elastica2\Query\AbstractQuery $query OPTIONAL Query object (default = null)
     */
     ...
     * @param mixed $query
     *
     * @throws \Elastica2\Exception\NotImplementedException
     *
     * @return self
     */
    ...
    {
        trigger_error('Deprecated: Elastica2\Query::setFilter() is deprecated. Use Elastica2\Query::setPostFilter() instead.', E_USER_DEPRECATED);
     ...
     * Set script fields.
     *
     * @param array|\Elastica2\ScriptFields $scriptFields Script fields
     *
     * @return $this
     *
     ...
     *
     * @param string                   $name
     * @param \Elastica2\AbstractScript $script Script object
     *
     * @return $this
     */
     ...
     *
     * @param \Elastica2\Facet\AbstractFacet $facet Facet object
     *
     * @return $this
     *
     * @deprecated Facets are deprecated and will be removed in a future release. You are encouraged to migrate to aggregations instead.
     ...
     * Add a suggest term.
     *
     * @param \Elastica2\Suggest $suggest suggestion object
     *
     * @return $this
     */
    ...
    public function setPostFilter($filter)
    {
        if (!($filter instanceof AbstractFilter)) {
            trigger_error('Deprecated: Elastica2\Query::setPostFilter() passing filter as array is deprecated. Pass instance of AbstractFilter instead.', E_USER_DEPRECATED);
        }
