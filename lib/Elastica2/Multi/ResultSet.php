<?php
namespace Elastica2\Multi;

use Elastica2\Exception\InvalidException;
use Elastica2\Response;
use Elastica2\ResultSet as BaseResultSet;
use Elastica2\Search as BaseSearch;

/**
 * Elastica2 multi search result set
...
class ResultSet implements \Iterator, \ArrayAccess, \Countable
{
     ...
     * Result Sets.
     *
     * @var array|\Elastica2\ResultSet[] Result Sets
     */
     ...
     * @param array|\Elastica2\Search[] $searches
     */
        ...
        if (isset($responseData['responses']) && is_array($responseData['responses'])) {
            ...
            foreach ($responseData['responses'] as $key => $responseData) {
                ...
                if ($currentSearch === false) {
                    ...
                    throw new InvalidException('Invalid object for search #'.$key.' provided. Should be Elastica2\Search');
                }
    ...
    /**
     * @return array|\Elastica2\ResultSet[]
     */
    ...
    /**
     * @return bool|\Elastica2\ResultSet
     */
