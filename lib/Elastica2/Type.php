...
class Type implements SearchableInterface
{
     ...
     *
     * @param \Elastica2\Document $doc Document with data
     *
     ...
     *
     * @param \Elastica2\Document|\Elastica2\Script $data    Document with update data
     ...
     *
     * @param \Elastica2\Type\Mapping|array $mapping Elastica2\Type\MappingType object or property array with all mappings
     *
     * @return \Elastica2\Response
     */
     ...
     *
     * @param \Elastica2\Document           $doc    Document to query for similar objects
     * @param array                        $params OPTIONAL Additional arguments for the query
     * @param string|array|\Elastica2\Query $query  OPTIONAL Query to filter the moreLikeThis results
     *
     * @return \Elastica2\ResultSet ResultSet with all results inside
     *
     ...
     *
     * @see \Elastica2\Type::addObject
     *
     * @param array|string $serializer @see \Elastica2\Type::_serializer
     *
     * @return $this
     */
