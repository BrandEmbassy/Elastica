...
use Elastica2\Exception\RuntimeException;
...
class Client
{
     ...
     * retryOnConflict: Use in \Elastica2\Client::updateDocument
    ...
    /**
     * @var \Elastica2\Request
     */
    protected $_lastRequest;

    /**
     * @var \Elastica2\Response
     */
    ...
    /**
     * Creates a new Elastica2 client.
     *
     ...
     *
     * @return \Elastica2\Index Index for the given name
     */
     ...
     *
     * @throws \Elastica2\Exception\InvalidException If $header or $headerValue is not a string
     *
     * @return $this
     */
     ...
     *
     * @throws \Elastica2\Exception\InvalidException If $header is not a string
     *
     * @return $this
     */
     ...
     *
     * Array of \Elastica2\Document as input. Index and type has to be
     * set inside the document, because for bulk settings documents,
     * documents can belong to any type and index
     *
     * @link http://www.elastic.co/guide/en/elasticsearch/reference/current/docs-bulk.html
     *
     * @param array|\Elastica2\Document[] $docs Array of Elastica2\Document
     *
     * @throws \Elastica2\Exception\InvalidException If docs is empty
     *
     * @return \Elastica2\Bulk\ResponseSet Response object
     */
    public function updateDocuments(array $docs)
    {
        ...
        $bulk->addDocuments($docs, \Elastica2\Bulk\Action::OP_TYPE_UPDATE);
     ...
     * @param array|\Elastica2\Script|\Elastica2\Document $data    raw data for request body
     ...
     *
     * @param array|\Elastica2\Document[] $docs
     *
     * @throws \Elastica2\Exception\InvalidException
     *
     ...
     *
     * @return \Elastica2\Status Status object
     */
     ...
     *
     * @return \Elastica2\Cluster Cluster object
     */
    ...
    /**
     * @param \Elastica2\Connection $connection
     *
     * @return $this
     */
     ...
     * @param string|\Elastica2\Index $index   Index name
     * @param string|\Elastica2\Type  $type    Type of documents
     ...
     * logging.
     *
     * @param string|\Elastica2\Request $context
     *
