...
use Elastica2\Bulk\Action\AbstractDocument as AbstractDocumentAction;
use Elastica2\Bulk\Response as BulkResponse;
use Elastica2\Bulk\ResponseSet;
use Elastica2\Exception\Bulk\ResponseException as BulkResponseException;
use Elastica2\Exception\Bulk\UdpException;
...
class Bulk
{
    ...
    /**
     * @param string|\Elastica2\Index $index
     *
     * @return $this
     */
    ...
    /**
     * @param \Elastica2\Bulk\Action[] $actions
     *
     * @return $this
     */
    ...
    /**
     * @param \Elastica2\Document[] $documents
     * @param string               $opType
     *
     * @return $this
     */
    ...
    /**
     * @param \Elastica2\Document[] $scripts
     * @param string               $opType
     *
     * @return $this
     */
    ...
    /**
     * @param \Elastica2\Script|\Elastica2\Document|array $data
     * @param string                                    $opType
     *
     * @return $this
     */
     ...
     *
     * @throws \Elastica2\Exception\Bulk\ResponseException
     * @throws \Elastica2\Exception\InvalidException
     *
     * @return \Elastica2\Bulk\ResponseSet
     */
     ...
     * @param int    $port
     *
     * @throws \Elastica2\Exception\Bulk\UdpException
     */
