...
class HasChild extends AbstractFilter
{
     ...
     *
     * @param string|\Elastica2\Query|\Elastica2\Filter\AbstractFilter $query Query string or a Elastica2\Query object or a filter
     * @param string|\Elastica2\Type                                  $type  Child document type
     */
    ...
    {
        return $this->setParam('query', \Elastica2\Query::create($query));
    }

    /**
     * Sets the filter object.
     *
     * @param \Elastica2\Filter\AbstractFilter $filter
     *
     * @return $this
     */
