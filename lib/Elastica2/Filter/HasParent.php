...
class HasParent extends AbstractFilter
{
     ...
     *
     * @param string|\Elastica2\Query|\Elastica2\Filter\AbstractFilter $query Query string or a Query object or a filter
     * @param string|\Elastica2\Type                                  $type  Parent document type
     */
